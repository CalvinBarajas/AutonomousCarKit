...
int wheelSpeed = 240;  // Ex: 90 with full-charge on batt, 250 with low charge on batt (used for testing).
...
void loop() // Mandatory Function For UNO Boards
 {
   ...
   angle45Right = measureDistance(45);
   Serial.print("__angle45Right__");
   Serial.println(angle45Right);
   //delay(1000);
   ...
   angle135Left = measureDistance(135);
   Serial.print("__angle135Left__");
   Serial.println(angle135Left);
   //delay(1000);
  
  if(angle45Right < 30.0 || angle90Straight < 30.0 || angle135Left < 30.0) { // if ID:005
   wheelStop(5);
   delay(500);
   wheelReverse(5);
   wheelStop(5);
   ...
   angleRight = measureDistance(0);
   angleLeft = measureDistance(180);
